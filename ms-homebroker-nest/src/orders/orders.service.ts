...
import { Order as MongooseOrder } from './order.schema';
...
export class OrdersService {
  constructor(
    ...
    @InjectModel(MongooseOrder.name)
    private orderModel: Model<MongooseOrder>,
  ) {}
  ...
  subscribeEvents(wallet_id: string): Observable<IOrderEvent> {
